...
- Secret Manager live write 전 budget guard 적용
...
- budget guard는 현재 live `secret set`에만 강제 적용되어 있습니다.
- Cloud Run/Firebase deploy, API enable, init 같은 다른 live Google Cloud 작업에도 비용 가드를 연결해야 합니다.
