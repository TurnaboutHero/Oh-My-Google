...
- `budget ensure --yes` remains blocked with `BUDGET_ENSURE_LIVE_NOT_IMPLEMENTED`; the injected Budget API executor core and live gate contract can exist before live transport/auth wiring is opened.
