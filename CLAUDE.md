...
- Budget API create/update request execution, post-verification core, transport failure mapping, and opt-in fetch transport exist behind injected functions; CLI live mutation is not wired.
