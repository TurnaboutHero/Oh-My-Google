...
- Budget policy ensure must remain CLI dry-run only until live create/update has approval and transport/auth implementation review. Internal injected executor core, live gate contract, and transport failure mapping may exist before the live gate opens.
